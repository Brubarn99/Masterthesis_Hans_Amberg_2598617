...
if(length(high_missing) > 0) {
  ...
  cat("aber könnten die Modellqualität beeinträchtigen.\n")
}
...
# Fehlende Werte schätzen und Random Forest trainieren
# rfImpute führt eine Iteration von Imputation und Modelltraining durch
...
cat("Fehlende Werte im Test-Datensatz:", missing_count_test, "\n")
  ...
  # rfImpute für die Feature-Matrix (ohne Zielvariable)
  X_imputed <- rfImpute(
...
cat("✅ Imputation und Random Forest Modell erfolgreich trainiert.\n")
...
cat("✅ Enhanced Random Forest trainiert!\n")
print(rf_enhanced$bestTune)

```

 
Berechnung der Gütemaße des Modells:
```{r}
# ----- Gütemaße -----
...
predict_class <- predict(rf_enhanced, newdata = X_test_data)  # Gibt Spaltenindex (1-7) zurück
...
plot(test_basic[[target_var]], predict_class,
    ...
    main = "Random_Forest Klassifikation: Vorhersage vs. Realität")
abline(0, 1, col = "red", lwd = 2)

# Nach der Random_Forest Confusion Matrix


# Berechne MCC für Random_Forest
