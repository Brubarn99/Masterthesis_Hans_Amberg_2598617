...
suppressPackageStartupMessages({
  ...
  library(reshape2)       # Für Violin Plot
  library(pheatmap)       # Für heatmap
  library(glmnet)         # Für Hyperparametrisierung
  library(report)         # Für die Quellenangaben am Ende
})
...
Auswahl der Features nach Höhe der Korrelation:
```{r Korrelation_feature_selection}
# # Top Features nach Korrelation zur Zielvariable auswählen
# high_corr_features <- names(correlations)[1:20]  # Top 20 Features
# feature_cols <- high_corr_features  # Überschreibt die bisherige Auswahl
# 
...
```
Train-Test-Split und Selektierung der gewünschten Datenspalten:
```{r}
# ---- 6. ERSTES XGBOOST TRAINING (für Feature Importance) ----
cat("\n🚀 Erstes XGBoost Training für Feature Importance...\n")
...
plot(test_basic[[target_var]], predict,
    xlab = "Tatsächliche Werte",
    ylab = "Vorhergesagte Werte",
    main = "XGBoost Regression: Vorhersage vs. Realität")
