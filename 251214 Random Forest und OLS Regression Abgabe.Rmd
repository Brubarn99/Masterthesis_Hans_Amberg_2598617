...
suppressPackageStartupMessages({
  ...
  library(Metrics)        # Zusätzliche Metriken
...
# ---- 6. ERSTES RANDOM FOREST TRAINING (für Feature Importance) ----
cat("\n🌲 Erstes Random Forest Training für Feature Importance...\n")
...
# ---- 9. RANDOM FOREST MIT HYPERPARAMETER TUNING ----
...
# Ergebnisse
cat("🎯 MODELL-VERGLEICH:\n")
cat("Enhanced  MAE:", round(enhanced_mae, 4), "| RMSE:", round(enhanced_rmse, 4), "| R²:", round(enhanced_r2, 4), "\n")
...
rf_ergebnis <- ggplot(data.frame(Actual = y_test, Predicted = enhanced_pred), 
  ...
  xlim(1, 7) +
  ylim(1, 7) +
  coord_fixed(ratio = 1) +  # Gleiche Skalierung für x und y
